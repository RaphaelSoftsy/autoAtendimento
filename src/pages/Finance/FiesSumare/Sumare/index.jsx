    ...
    return (
        <main className="repayment">
            <div className='repayment-card'>
                <CardCheckout
                    text='Descreva o problema ou a solicitação relacionada ao Super Sumaré, incluindo detalhes específicos e informações necessárias. Anexe documentos relevantes ou comprovantes (obrigatório).'
