        ...
        <main>
            <div className="rescue-checks">
                <div className='list-subjects'>
                    <CardCheckout
                        text='Descreva o problema encontrado na declaração específica acadêmica, incluindo detalhes sobre os dados incorretos e as correções necessárias. Anexe uma cópia da declaração e qualquer documento relevante (obrigatório).'
