...
export const listRoutesAcademic = [
    ...
    {
        id: 6,
        name: 'Disciplinas Cursadas na Sumaré',
        header: 'Disciplinas Cursadas na Sumaré',
        route: '/academico/solicitacoes-academicas/aproveitamento-de-estudos/aproveitamento-disciplinas-cursadas-na-sumare'
    },
    {
        id: 7,
        name: 'Disciplinas Cursadas em Outras Faculdades',
        header: 'Disciplinas Cursadas em Outras Faculdades',
